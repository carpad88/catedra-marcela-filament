...
class GroupPolicy
{
    ...
    {
        return $user->can('view_group') && $user->id === $group->owner_id;
    }
    ...
    {
        return $user->can('update_group') && $user->id === $group->owner_id;
    }
    ...
    {
        return $user->can('delete_group') && $user->id === $group->owner_id;
    }
